...
import {TableDefault} from "./fieldProgram/TableDefault";
import menuIcon from "../resources/menu.png"
import {AsideMenu} from "./AsideMenu"
import h from "../resources/h.png"
import {TableDinamic} from "./fieldProgram/TableDinamic";
                ...
                <form>
                    ...
                    <div className="form-group form-margin-left">
                        <div className="div-margin-3 align-content-start flex-nowrap d-flex flex-row bd-highlight mb-3">
                            ...
                            <div>
                                <TableDinamic id={currentPlace} operation={operation} array={array} handleArray={handleArray()}/>
                            </div>
                        </div>
                        ...
                        <div className="div-margin-3 align-content-start flex-nowrap d-flex flex-row bd-highlight mb-3">
                            ...
                            <div>
                                <button type="button" className="btn btn-outline-primary" onClick={
                                    ...
                                    Отрезок <img className="icon-h" src={h} alt=""/>
                                </button>
                            </div>
                            <div>
                                <button type="button" className="btn btn-outline-primary" onClick={
                                    ...
                                    Эллипс <img className="icon-h" src={h} alt=""/>
                                </button>
                            </div>
                            <div>
                                <button type="button" className="btn btn-outline-primary" onClick={
                                    () => {
                                        addCommands({name: 'Прямоугольник', ident: 'RECTANGLE'})
                                        fetchCommands()
                                    }}>
                                    Прямоугольник <img className="icon-h" src={h} alt=""/>
                                </button>
                            </div>
                            <div>
                                <button type="button" className="btn btn-outline-primary" onClick={
                                    ...
                                    Поворот <img className="icon-h" src={h} alt=""/>
                                </button>
                            </div>
                            <div>
                                <button type="button" className="btn btn-outline-primary" data-toggle="modal" data-target="#examplePaint" onClick={
                                    ...
                                    Закрась <img className="icon-h" src={h} alt=""/>
                                </button>
